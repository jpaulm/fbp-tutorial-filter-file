...
When you are ready to add the filter function, you will of course need to delete the existing arrow - right click on the arrow itself, and select Delete; add the two additional bloacks, and hook everything up! 
